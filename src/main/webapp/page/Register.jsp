...
<script src="js/wb.js" type="text/javascript" charset="utf-8"></script>
<script src="js/api" type="text/javascript"></script>
...
.s_code_pickup ul li a {
	text-decoration: none;
	color: #ff6600;
}

.s_code_pickup ul li a:hover {
	color: #ff9900;
}
</style>
...
-->
		...
		<div class="com-w bh-posRlt">
			...
			<div class="menu_1">
				<ul>
					...
					<li><a href="page/Login.jsp"
						style="color: #e76d26; border-bottom: 2px solid #e76d26;">商户中心</a></li>
					...
					<form class="form-horizontal" action="" method="post" id="iform"
						...
						<div class="zln-join_box zln-c">
							<div class="zln-join_title">
								<span>验证信息</span><font></font>
							</div>
							<ul>
								<li class="zln-li1"><span>手机号</span> <input id="uphone"
									name="uphone" onkeyup="this.value=this.value.replace(/\D/g,'')"
									onafterpaste="this.value=this.value.replace(/\D/g,'')"
									class="zln-text1" maxlength="11" type="text"> <input
									style="width: 99px" class="yzm-btn disabled" id="getMsgBtn"
									value="获取验证码" type="button" onclick="getCaptcha()"></li>
								<li class="zln-li1"><span>手机验证码</span> <input
									class="zln-text1" id="vaildNum"
									onkeyup="this.value=this.value.replace(/\D/g,'')"
									onafterpaste="this.value=this.value.replace(/\D/g,'')"
									name="vaildNum" maxlength="6" type="text"> <input
									id="vaild" name="vaild" type="hidden"></li>
								<span id="codeMsg" style="color: red"></span>
								<li class="zln-li1"><span>登录密码</span> <input
									class="zln-text1" id="upwd" name="upwd" maxlength="12"
									type="password" placeholder="请输入3-12位字母或数字"> <span
									id="PwdMsg" style="color: red; width: 20rem;"></span></li>

								<li class="zln-li1"><span>确认密码</span> <input
									class="zln-text1" id="password02" name="password02"
									maxlength="12" type="password" placeholder="请再次确认密码"> <span
									id="comfirPwdMsg" style="color: red; width: 10rem;"></span></li>
						...
						<div class="zln-join_box zln-c">
							...
							<ul>
								<li class="zln-li1"><span>用户昵称</span> <input id="uname"
									name="uname" class="zln-text1" type="text" placeholder="">
									<font></font></li>
								<li class="zln-li1"><span>用户性别</span> &nbsp;<input
									type="radio" name="usex" value="男" checked="checked">
									&nbsp;男&nbsp;&nbsp;<input type="radio" name="usex" value="女" />
									&nbsp; 女</li>

								<li class="zln-li1"><span>用户邮箱</span> <input id="uemail"
									name="uemail" class="zln-text1" type="email"></li>

								<li class="zln-li1"><span>所在学校</span> <input id="uaddr"
									name="uaddr" class="zln-text1" type="text"></li>
								...
								<li class="zln-li1"><span>用户头像<br> <b
										class="need">(点我)</b></span>

									<div class="zw">
										<input name="upicdata" id="upicture" multiple="multiple"
											type="file" style="display: none" onchange="addpic(this)">
										<a href=""
											onclick="document.getElementById('upicture').click();return false;"><div
												id="divdcardf">
												<img id="upicimage" src="image/zw.jpg">
											</div></a>
									</div> <!--   <span class="last">证件照片<br>
								...
								<li class="zln-li1"
									style="padding-left: 153px; color: #000; font-size: 14px">
									<input id="isnot" name="isnot" type="checkbox"
									required="required"> 同意协议 <a
									href="javascript:void(null)" onclick="joinUs();"
									style="color: #00f">点击查看协议条款&gt;&gt;</a>
								</li>
								<li class="zln-dtest zln-li1"><span>&nbsp;</span>

									<div class="zln-libt_a">

										<input id="submitOk" value="完成注册" class="zln-button"
											type="submit">
	...
	<div id="confirm" class="content"
		style="width: 800px; height: 600px; background-color: #FFFFFF; overflow: auto; display: none;">
		<h3 align="center">
			<strong>宅小递客户协议</strong>
		</h3>

		<h2 align="center">增值服务平台加入协议</h2>

		<p>
			<strong>甲方：宅小递工作室（以下简称“甲方”）</strong><br> <strong>乙方：__________________________________（以下简称“乙方”）</strong>

		</p>
		<p>&nbsp;&nbsp;&nbsp;&nbsp;宅小递是甲方建设、投资和运营的社区物流与生活服务平台（以下简称“宅小递平台”），
			致力于为有社区生活增值服务需求的个人或单位（以下简称“用户”）与提供增值服务的商户（以下简称“商户”）搭建第三方交易平台，
			并提供相关的信息、管理等服务。
			同时，甲方为所有合作商户构建宅小递社区服务联盟（以下简称“宅小递联盟”），乙方希望正式加入宅小递平台并在该平台上开展相应的业务。
			经甲乙双方友好协商， 就乙方加入宅小递平台开展相应业务等相关事宜订立如下一致协议：</p>
		<h4>
			<strong>第一条 双方基本信息</strong>
		</h4>

		<p>
			&nbsp;&nbsp;&nbsp;&nbsp;甲方系经工商行政管理局登记注册的合法法人，具有独立民事行为能力，能独立承担本协议全部的权利义务。
			甲方有权授权甲方的关联公司处理与本协议相关的所有事项。<br> 甲方的营业地址：北京市朝阳区小关北里甲2号渔阳置业大厦B403，<br>
			电话: 010-59802933, 电子邮件:
			kf@shouhuobao.com，微信号：shouhuobao，甲方支付宝账户：alexluo@collectplus.cn
			甲方银行账户：户名：客恩瑞（北京）网络技术有限公司 开户行：中国工商银行望京支行 账号：0200 0035 1900 0186 638
			乙方系具有独立民事行为能力的法人或个人，能独立承担本协议全部的权利义务。
		</p>
		<h4>
			<strong>第二条 双方合作内容及合作条件</strong>
		</h4>

		<p>
			1、合作内容：乙方门店申请成为甲方授权的增值服务网点, 自愿为其潜在用户提供社区增值生活服务或开展社区电子商务业务；<br>
			2、合作条件：<br> 2.1、乙方需提供具备实时上网条件的智能手机、平板或电脑；<br>
			...
			2.5、乙方在甲方平台系统产生服务费时，甲方可先行扣除500元作为合作保证金并予以冻结，当系统余额超过500元时，超额部分乙方可以根据实际情况提现。冻结的保证金，在双方合作结束且无异议时退还。
		</p>
		<h4>
			<strong>第三条 收益与结算</strong>
		</h4>

		<p>
			1. 在本协议有效期内，通过甲乙方双方的共同努力，达到促进乙方收益的持续增长（详见附件二）；<br> 2. 收益结算方式：<br>
			&nbsp;&nbsp;&nbsp;&nbsp;
		...
		<h4>
			<strong>第四条 甲方的权利与义务</strong>
		</h4>

		<p>
			1、甲方负责提供自身研发的宅小递平台及终端应用软件（以下简称“系统”）， 并负责系统的定期维护与更新，保证其良好的工作状态。<br>
			...
			6、甲方有权为符合其评估条件的门店配备相应的展示物料，乙方应予以配合。
		</p>
		<h4>
			<strong>第五条 乙方的权利与义务</strong>
		</h4>

		<p>
			1、在本协议约定的期限内，乙方不得与其他公司或个人再签订与本协议类似的协议或文件，不得以任何形式再加入任何与宅小递平台类似的增值服务平台，一经发现，甲方有权立即中止合作并扣除账户所有余额。<br>
			...
			6、乙方有权向甲方申请相应的基础物料，甲方将根据乙方业务的开展情况提供有偿或无偿的业务物料及宣传品，但物料送至乙方的运输费用由乙方承担。
		</p>
		<h4>
		...
		<p>
			任何一方均不得违反本协议的约定，否则对方有权要求违约方限期改正，逾期仍未改正的，对方有权解除本协议并追究其违约责任。常见的违约情况包含但不限于如下列表：<br>
			违约情况&nbsp;&nbsp;&nbsp;&nbsp; 违约及赔偿责任<br>
			货物丢失&nbsp;&nbsp;&nbsp;&nbsp; 货物的实际价值<br> 临时暂停服务而未提前通知甲方
			首次警告，再次罚款100元<br> 人为损坏设备或物料&nbsp;&nbsp;&nbsp;&nbsp;
			按设备或物料的实际价值进行赔偿<br> 弄虚作假、伪造订单等行为&nbsp;&nbsp;&nbsp;&nbsp;
			首次扣除所有虚假订单收益，再次以当月服务费用作为罚款<br> 擅自向用户重复收费或多收费
			&nbsp;&nbsp;&nbsp;&nbsp; 首次罚款50元，再次以当月服务费用作为罚款
		</p>
		<h4>
			<strong>第七条 续约与解约</strong>
		</h4>

		<p>
			1、本协议有效期三年，双方完成签署后自甲方审核通过并开通运营之日起正式生效。协议期满双方均未提出异议时，本协议自动延续。<br>
