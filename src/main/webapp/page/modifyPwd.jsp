						...
						<div topbar-profilebox="">
							<div class="topbar-profilebox">
								...
								<span class="topbar-profilebox-avatar icon-profile ng-hide"
									...
									class="topbar-profilebox-username ng-binding">${loginUser.uname}</span> <!-- ngIf: $root.topbarType === 'checkout' -->
									<!-- ngIf: $root.topbarType !== 'checkout' --> <span
				...
				<div class="profile-panelcontent" ng-transclude="">
					<form class="changepwd ng-scope ng-pristine ng-valid"
						...
						<div class="formfield ng-isolate-scope"
							...
							form-field="" label="旧密码" model="changePwdData" property="newPwd">
							<label ng-bind="label" class="ng-binding">旧密码</label>
							<input name="oldPwd" id="oldPwd" placeholder="请输入旧密码"  
								type="password" onblur="checkOldPwd()" />
