...
<link href="css/registerDai/iconfont.css" type="text/css"
	rel="stylesheet">
...
<body>
				...
				<ul>
					<li class="h-qq"><em></em>
						<div class="qq-tanchu">
							<b></b>
							<p>
								校园快递在线客服<br> <span class="gray">1914588314</span>
							</p>
	...
	<div class="shop-banner">
		<div class="com-w">
			<div class=" "
				style="width: 50% px; margin-top: 4rem; display: inline-block;">
				<h1>成为待递员吧!</h1>
				<br> <span>成为待递员吧!你可以以此赚取小费,认识朋友</span><br> <span>说不定还能遇见另一半</span><br>
				<br> <br> <a href="page/RegisterDai.jsp"><i
					class="iconfont">&#xe606;</i></a>
			</div>
			<div class="login-form">
				...
				<form method="post" id="loginForm" action="user/login">
					...
					<div class="bh-item">
						<input id="j_username" name="uphone" placeholder="请输入手机号"
					...
					<input class="btn" style="cursor: pointer;"
						onclick="return loginSub()" value="快速登录" type="submit">
				</form>
			</div>
		</div>
	</div>
	<div class="shop-intro">
		<div class="com-w">
			<h3 class="com-title1">什么是校园快递联盟</h3>
			<p style="line-height: 240%; font-size: 16px;">
				2011年4月，校园快递在北京从第三方代收货平台开始做起；<br>2013年，校园快递的服务已经覆盖北京、上海、广州、深圳四个城市，网点不断增长，用户迅速翻倍，社区物流与生活服务平台初见雏形；
				<br>2014年6月，正式成立校园快递联盟，我们为盟友量身打造全方位发展服务计划，
	...
	<div class="cooperative cooperative1 bh-posRlt">
		<div class="com-w">
			<h3 class="com-title">校园快递加盟政策&amp;费用</h3>
	...
	<div class="big-yellow-btn">
		<a
			href="http://www.shouhuobao.com/merchant/merchant/disp-merchant-add.html">加入校园快递联盟，用互联网+赚钱更轻松</a>
	</div>
	<div class="footer">
		<div class="com-w">
			<div class="bh-overf">
