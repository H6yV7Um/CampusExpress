...
public class User {
	...
	public String toString() {
		return "Zuser [uuid=" + uuid + ", upwd=" + upwd + ", uname=" + uname + ", urelname=" + urelname + ", uphone="
				+ uphone + ", uemail=" + uemail + ", usex=" + usex + ", upicture=" + upicture + ", uaddr=" + uaddr
				+ ", utype=" + utype + ", ustatus=" + ustatus + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((urelname == null) ? 0 : urelname.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (upwd == null) {
			...
			return false;
		if (urelname == null) {
			if (other.urelname != null)
				return false;
		} else if (!urelname.equals(other.urelname))
			return false;
		if (usex == null) {
			if (other.usex != null)
				return false;
